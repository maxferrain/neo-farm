...
const SingleTeam = ({ team }: { team: TeamType }) => {
  const { image, name, designation, companies, facebookLink, twitterLink, instagramLink } =
    team;
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/3 xl:w-1/3">
      <div className="h-[340px] shadow-testimonial dark:bg-dark group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 dark:shadow-none">
