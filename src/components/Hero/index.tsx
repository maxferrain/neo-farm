...
const Hero = () => {
  return (
      <section
        id="home"
        className="relative overflow-hidden pt-[250px] md:pt-[130px] lg:pt-[170px] bg-hero-pattern bg-center md:bg-cover bg-hero-bg-size bg-no-repeat bg-middle"
      >
          ...
          <div className="-mx-4 flex flex-wrap ">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <h1 className="mb-7 max-w-[780px] text-2xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                ...
                <p className="mb-14 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Инновации в&nbsp;агробизнесе:<br/>уникальная платформа <br className='md:hidden'/>на&nbsp;пересечении <br className='md:hidden'/>фермерства и&nbsp;финтеха
                </p>
