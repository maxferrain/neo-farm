    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="В этом разделе мы предусмотрели ответы на самые распространенные вопросы, которые могут возникнуть у вас при использовании нашей платформы. Здесь вы найдете информацию о том, что такое Цифровые Финансовые Активы (ЦФА), как они используются для животных на вашей ферме, как обеспечивается безопасность ваших ЦФА и многое другое."
          width="940px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="Что такое Цифровые Финансовые Активы (ЦФА)?"
              answer="Цифровой финансовый актив - это тип актива, который представляет собой цифровые права, включая денежные требования, возможность применения в качестве средства иного ценного бумага, а также цифровые токены."
            />
            <SingleFaq
              question="Каким образом ЦФА используется для животных на ферме?"
              answer="Через нашу платформу, каждое животное вы можете занести в систему, создав карточку с описанием и другой важной информацией. После этого животное становится цифровым активом, которым удобно управлять и который можно использовать в финансовых операциях."
            />
            <SingleFaq
              question="Что такое регуляция Банка России и как она связана с вашим сервисом?"
              answer="Банк России устанавливает стандарты и регулирование для финансовых операций, чтобы предотвратить мошенничество и обеспечить защиту пользователей. Наша платформа полностью соответствует регуляциям Банка России, что обеспечивает безопасность и надежность ваших активов и операций."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="Действительно ли ЦФА могут улучшить мой фермерский бизнес?"
              answer="Абсолютно. ЦФА облегчают управление активами, предоставляя гибкие и эффективные инструменты для мониторинга и торговли активами, а также снижают затраты на связанные с бюрократией процедуры."
            />
            <SingleFaq
              question="Как начать использовать вашу платформу уже сегодня?"
              answer="Просто зарегистрируйтесь на нашем веб-сайте, следуйте инструкциям для создания своего первого ЦФА и начните пользоваться всеми преимуществами цифрового сельского хозяйства сегодня. Стоимость и комиссии зависят от пакета услуг, который вы выбираете. "
            />
            <SingleFaq
              question="Является ли процесс выдачи ЦФА сложным?"
              answer="Нет, весь процесc предназначен для того, чтобы быть максимально удобным и простым для пользователя. Всё, что вам нужно делать - это ввести необходимую информацию о вашем животном, и наша система сделает остальное, превращая его в цифровой актив."
            />
          </div>
        </div>
      </div>
